...
export async function updateSession(request: NextRequest) {
  ...
  // debug issues with sessions being lost.
  ...
  if (
    ...
    !request.nextUrl.pathname.startsWith('/teacher/signup') &&
  ...
  // If you are using NextResponse.redirect() or NextResponse.rewrite(), make sure to
  // copy over the cookies from supabaseResponse.cookies.getAll().
